...
//	}
	 ...
	 * userEmail); mav.addObject("userID", userID); mav.addObject("userName",
	 * userName); mav.addObject("userEmail", userEmail); return mav; }
	 */
	 ...
	 * System.out.println("userName: "+userName);
	 * 
	 * mav.addObject("info", info); mav.setViewName("result"); return mav; }
	 */
